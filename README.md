...
Este es el proyecto de mitad de semestre para la clase de Visión Artificial. El sistema procesa video en tiempo real para generar un campo de partículas reactivo basado en el movimiento del usuario.
